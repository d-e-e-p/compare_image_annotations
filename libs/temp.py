...
from PyQt5.QtGui import QAction, QColor, QCursor, QImage, QImageReader, QPixmap
from PyQt5.QtCore import (QByteArray, QFileInfo, QPoint, QPointF, QProcess, QSize, QTimer, QVariant,
                          Qt)
from PyQt5.QtWidgets import (QApplication, QCheckBox, QDockWidget, QFileDialog, QHBoxLayout, QLabel,
                             QLineEdit, QListWidget, QListWidgetItem, QMainWindow, QMenu,
                             QMessageBox, QRadioButton, QScrollArea, QToolButton, QVBoxLayout,
...
#.#        # file list
    ...
    def load_file(self, file_path=None):
        ...
        if unicode_file_path and os.path.exists(unicode_file_path):
            ...
            self.show_class_list_for_image_file(file_path)
    ...
    def draw_overlay_on_canvas(self):
        if self.current_draw_object.image != self.current_image:
            ...
            return
        #image_to_overlay == Plotter.fetch_overlay_image(self.current_draw_object)
        #self.canvas.drawImage(image_to_overlay)
...
def run_main_gui(bbl, pl, image_dir, save_dir):
    ...
    win = MainWindow(bbl, image_dir, save_dir)
    win.show()
